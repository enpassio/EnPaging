...
package com.enpassio.pagingsample.commonmodel.networkmodel;
...
public class NewsResponse implements Parcelable {
    ...
    protected NewsResponse(Parcel in) {
        ...
        in.readList(this.articles, (com.enpassio.pagingsample.commonmodel.networkmodel.Article.class.getClassLoader()));
    }
